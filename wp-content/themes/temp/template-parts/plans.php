<main class="plans-container">
    ...
    <article class="single" id="studios">
        ...
        <div class="wrapper">
            ...
            <div class="content">
                Компактная студия позволит вместить все необходимое благодаря продуманной планировке и выделенным
                местам под хранение. Студии представлены с теплыми лоджиями, где можно обустроить зону для работы или
